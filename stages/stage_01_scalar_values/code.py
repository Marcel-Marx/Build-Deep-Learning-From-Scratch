...
class Value:
    ...
    def __init__(self, data, _children=(), _op=""):
        ...
        self._op = _op
        self._backward = lambda: None    # its a dummy-function for later implementation
    ...
    # We can now do basic operations (+, *, **) without the need of _make
    ...
    # So we can also do these operations the other way around

    def __radd__(self, other):
        """Return other + self."""
        # This unfortunatly produces a RecursiveError. Why: I think, because + and * are commutative
        return self + other
